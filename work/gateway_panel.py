...
class eNB_ping(gr.top_block):
    ...
    def __init__(self,**param):
        ...
        self.msg_connect(self.lte_sat_dl_subframe_mapper_0_0, "sched_for_ul", self.lte_sat_ul_subframe_demapper_0, "sched_for_ul")
        self.msg_connect(self.lte_sat_ul_baseband_sync_0, "TA_info", self.lte_sat_ul_subframe_demapper_0, "TA_inf")
        self.msg_connect(self.lte_sat_layer2_0, "sdus", self.blocks_tuntap_pdu_0, "pdus")
        self.msg_connect(self.blocks_tuntap_pdu_0, "pdus", self.lte_sat_layer2_0, "pdus")
